...
form for use with Verilog simulation. The design deliberately favors
...
a small register file and a limited but useful instruction set.
...
\textit{Writing a C Compiler}. Here, TACKY refers to a tiny abstract
...
The discussion of the TACKY-style intermediate representation in this report
is informed by the following compiler text:

\begin{center}
Nora Sandler, \textit{Writing a C Compiler}, No Starch Press, 2024.
\end{center}
